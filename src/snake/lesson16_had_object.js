/*
## Object je zlozena premenna. Tj ma pod-premenne alebo vlastnosti.
Napriklad pole je **object**, a length je vlastnost pola. 

### Pole vytvarame cez kucerave zatvorky
```
var obj = { x: 1, y: 2 };
```

### K vlastnostiam objectu pristupujeme cez bodku .
```
obj.x = obj.x + 1;
```

Alebo cez hranate zatvorky
```
obj["x"] = obj["x"] + 1;
```

### 1. Nahrad polia hadx a hady jednym polom, kde clanky budu objecty {x, y}.
